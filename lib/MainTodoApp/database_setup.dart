...
class SQLHelper {
  ...
  static final String _tableName = "todo_table";
  static final String _dbApp = 'todo_table.db';
...
// created_at: the time that the item was created. It will be automatically handled by SQLite
  ...
  static Future<int> createItem(DataModel dataModel) async {
    final db = await SQLHelper.db();
    //this prevent us from listing our content as stated in the comment section
    //final data = TaskModel();
    //final data = {};
    //return await db.delete(_tableName);
    final id = await db.insert(_tableName, dataModel.toJson(),
  ...
  static Future<int> updateItem( int id, DataModel updatedDataModel) async {
    final db = await SQLHelper.db();
